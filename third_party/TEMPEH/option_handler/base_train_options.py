...
class BaseTrainOptions():
    ...
    def initialize(self):
        ...
        # train
        self.add_arg( cate='train', abbr='b',   name='batch-size', type=int, default=1)
        self.add_arg( cate='train', abbr='lr',  name='learning-rate', type=float, default=1e-3) # 1e-3
        self.add_arg( cate='train', abbr='lr-linear-steps', name='lr-linear-steps', type=int, default=100)
        self.add_arg( cate='train', abbr='lr-constant-steps', name='lr-constant-steps', type=int, default=100_000)
        self.add_arg( cate='train', abbr='lr-decay-steps', name='lr-decay-steps', type=int, default=10_000)
        self.add_arg( cate='train', abbr='lr-decay-rate', name='lr-decay-rate', type=float, default=0.97)
        self.add_arg( cate='train', abbr='lr-min-multiplier', name='lr-min-multiplier', type=float, default=0.0)
        ...
        self.add_arg( cate='data', abbr='thread', name='thread-num', type=str, default=32)
