...
class Model(BaseModel):
    ...
    def __init__(self, input_ch, output_ch, architecture, **kwargs):
        ...
        elif self.architecture == 'custom_unet':
            from modules import custom_feature_extractor_net
            self.model = custom_feature_extractor_net.CustomFeatureExtractorNet(c_in=self.input_ch, c_out=self.output_ch)     
        else:
